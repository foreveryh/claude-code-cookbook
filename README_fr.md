...
| `/pr-create-smart` | Générer un brouillon de description PR de haute qualité à partir des changements; compléter votre flux de création de PR. Remarque : la création de la PR se fait via `gh` ou l’UI de l’hébergeur. |
